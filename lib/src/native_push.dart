...
final class NativePush {
  ...
  Future<Map<String, String>?> initialNotification() async =>
      NativePushPlatform.instance.initialNotification();
  ...
  Future<bool> registerForRemoteNotification(
      ...
      NativePushPlatform.instance
          .registerForRemoteNotification(options: options, vapidKey: vapidKey);
  ...
  Future<(NotificationService, String?)> get notificationToken =>
      NativePushPlatform.instance.notificationToken;
  ...
  Stream<(NotificationService, String?)> get notificationTokenStream =>
      NativePushPlatform.instance.notificationTokenStream;
